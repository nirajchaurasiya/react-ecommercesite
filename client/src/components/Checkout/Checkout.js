...
export default function Checkout() {
    ...
    return (
        <div className='py-14'>
            ...
            <form className='bg-white shadow-md py-14 mx-auto w-[90vw] rounded-lg p-10'>
                <div className=''>
                                    ...
                                    {/* <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                                        ...
                                        <div className="mt-4 text-center">
                                            ...
                                            <div className='flex justify-center mt-2'>
                                                <button type="button" disabled className="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium text-sm px-2 w-[70%] py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { setSteptwo(false); setStepThree(true); setGateaWay(true) }}>Choose</button>
                                            </div>
                                        </div>
                                    </div> */}
                    ...
                    <>
                        ...
                        {cashOnDelivery &&
                            <section className="text-gray-600 body-font py-12">
                                <div className="p-4 mb-4 text-md text-black rounded-lg bg-blue-50 " role="alert">You chose,
