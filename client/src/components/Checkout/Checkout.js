...
export default function Checkout() {
                    ...
                    <div className="flex flex-col text-center w-full mb-20">
                        <img className='h-24 w-24 rounded-2xl m-auto' src="/images/logo.jpg" alt="logo" />
                        {
                            reviews ? <>
                                ...
                                :
                                <>
                                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-1 text-gray-500">Review completed. <br /> Below is your track ID <br /> <div className='text-gray-900 text-bold'><div className="bg-white rounded-lg p-4">
    ...
    return (
        <div className='py-14 w-[90vw] flex justify-center mx-auto bg-white shadow-md '>
            {showWarning && <Toast />}
            <div className='flex flex-wrap justify-center gap-3'>
                <form className='py-14 rounded-lg'>
                    <CheckoutTop />
                    {stepOne &&
                        <div>
                ...
                <div className='lg:w-[80%] xl:w-[60%] md:w-full sm:w-full'>
                    {loader ?
                        <Loader /> :
                        localStoreDatas?.length >= 1 ?
                            <div className=" pt-20 pb-32">
                                <h1 className="mb-10 text-center text-2xl font-bold">Cart Items</h1>
                                <div className="mx-auto max-w-5xl flex flex-wrap justify-center px-6 xl:px-0">
