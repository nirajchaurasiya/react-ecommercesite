    ...
    return (
        <div>
            <body className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"
                style={{ backgroundImage: "url('/images/userimage.png');" }}>
                <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                    <div id="profile"
                        className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                        <div className="p-4 md:p-12 text-center lg:text-left">
                            <div className="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center"
                                style={{ backgroundImage: " url('/images/userimage.png')" }}></div>
                    ...
                    <div className="w-full lg:w-2/5">
                        <img src="/images/userimage.png" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" alt="profile" />
