        ...
        <div>
            <footer className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto w-[90vw] text-sm">
                    <div className="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                        ...
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a target="_blank" href="https://garammasalaofficial.com"
                                        className="text-gray-600 hover:text-gray-800">Garam Masala</a>
                                </li>
                                <li>
                                    <a target="_blank" href="https://agarbatiofficial.com"
                        ...
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a target="_active" href="https://facebook.com/binary.baron0"
                        ...
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">9829279569</a>
                                </li>
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">9811113421</a>
                                </li>
                                <li>
                                    <a className="text-gray-600 hover:text-gray-800">9828758167</a>
                                </li>
                            </nav>
                        </div>
                        <div className="lg:w-1/6 md:w-1/2 w-full px-4">
                ...
                <div className="border-t border-gray-200 w-[90vw] m-auto">
                    <div className="container px-5 py-8 flex flex-wrap mx-auto items-center" id="abId0.40277924950961075">
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 nirajchaurasiya —
                            <a href="https://nirajchaurasiya.com" className="text-gray-600 ml-1" target="_blank"
                                rel="noopener noreferrer">@nirajchaurasiya</a>
                        </p>
                    </div>
                </div>
            </footer>
