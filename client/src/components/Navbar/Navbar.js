...
export default function Navbar() {
    ...
    useEffect(() => {
        if (localStorage.getItem('shopkartStore')) {
            const uid = localStorage.getItem('shopkartStore');
            const withoutQuotes = uid.replace(/"/g, '');
            setUid(withoutQuotes)
        }
                ...
                <div className=" flex flex-wrap items-center justify-between mx-auto pr-2 pl-1 pb-3 pt-3">
                    ...
                    <div className="items-center hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col items-center font-medium p-4 md:p-0 mt-5 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-5 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <li>
                                <NavLink to="/category" className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Category</NavLink>
                            </li>
                            <li>
                            ...
                            {user ? <li>
                                <NavLink to={`/profile/${uid}`} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Profile</NavLink>
                            </li> : <li>
